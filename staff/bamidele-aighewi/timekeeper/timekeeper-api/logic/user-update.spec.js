...
describe('userUpdate', () => {
    ...
    it('should fail on non integer id parameter', () => {
        ...
        target = false
        expect(() => userUpdate(target)).to.throw(TypeError, `${name} ${target} is not a string`)
    ...
    it('should fail on non object props parameter', () => {
        ...
        target = false
        expect(() => userUpdate('ownerId', target)).to.throw(TypeError, `${name} ${target} is not a Object`)
