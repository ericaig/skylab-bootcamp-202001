...
class App extends Component {
    state = { view: 'main', detail: undefined, query: undefined, mainView: 'searchResults', error: undefined, user: undefined, teams: [], events:{} }
        ...
        try {
            retrieveTeamDetail(team.idTeam, (error, detail) => {
                ...
                retrieveEvents(team.idTeam, (error, events) =>{
                    ...
                    this.setState({ detail, events, mainView: 'teamDetail' })
                })
            })
        } catch (error) {
            this.__handleError__(error.message)
    ...
    render() {
        const { state: { view, mainView, user, teams, query, detail, events }, handleGoToDetail, handleSearchTeams, handleLogin, handleRegister, handleGoToRegister, handleGoToLogin, handleProfile, handleGoToProfile, handleNavigation, handleGoToResults } = this
        return <div>
            <Header
