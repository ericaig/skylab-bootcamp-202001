...
describe('eventCompanyRetrieve', () => {
    ...
    it('should fail on invalid date start parameter', () => {
        ...
        target = "a string"
        expect(() => unitFunction(target)).to.throw(TypeError, `${target} is not a valid date`)
    ...
    it('should fail on invalid date end parameter', () => {
        ...
        target = "a string"
        expect(() => unitFunction('2020-03-31', target)).to.throw(TypeError, `${target} is not a valid date`)
    ...
    it('should fail on non integer type parameter', () => {
        ...
        target = false
        expect(() => unitFunction('2020-03-31', '2020-04-01', target)).to.throw(TypeError, `${name} ${target} is not a number`)
    ...
    it('should fail on non integer state parameter', () => {
        ...
        target = false
        expect(() => unitFunction('2020-03-31', '2020-04-01', WORK_DAY, target)).to.throw(TypeError, `${name} ${target} is not a number`)
